...
class Index {
    constructor(
        ...
        this.localEnv = {
            ...
            CONFLUENCE_UPDATE_BA: CONFLUENCE_UPDATE_BA,
            CONFLUENCE_UPDATE_BA_ID: CONFLUENCE_UPDATE_BA_ID,
            CONFLUENCE_UPDATE_BA_IMPLEMENTED: CONFLUENCE_UPDATE_BA_IMPLEMENTED,
            CONFLUENCE_UPDATE_BA_APPROVED: CONFLUENCE_UPDATE_BA_APPROVED,
            CONFLUENCE_UPDATE_APPROVAL_BOARD: CONFLUENCE_UPDATE_APPROVAL_BOARD,
            CONFLUENCE_UPDATE_APPROVAL_BOARD_ID: CONFLUENCE_UPDATE_APPROVAL_BOARD_ID,
